...
package com.codeazur.fzip
{
	 ...
	 * <li>If running in the Flash Player 9 browser plugin, FZip requires ZIPs to be 
	 * patched (Adler32 checksums need to be added). This is <i><u>not</u></i> required if
	 * FZip runs in Flash Player 10 or in the Adobe AIR runtime, or if files contained in the ZIP 
