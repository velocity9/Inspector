package v9.exporters
{
	...
	public class SVGCustomShapeExporter extends DefaultSVGShapeExporter
	{
		...
		protected var characterId:String;
		
		public function SVGCustomShapeExporter(swf:SWF, characterId:String) {
			super(swf);
		...
		override public function beginShape():void {
			_svg = <svg xmlns={s.uri} xmlns:xlink={xlink.uri}><g id={characterId} /></svg>;
		...
		override public function beginGradientFill(type:String, colors:Array, alphas:Array, ratios:Array, matrix:Matrix = null, spreadMethod:String = SpreadMethod.PAD, interpolationMethod:String = InterpolationMethod.RGB, focalPointRatio:Number = 0):void {
			...
			var gradientId:String = "g" + id + "_" + characterId;
			gradient.@id = gradientId;
			path.@stroke = "none";
			path.@fill = "url(#" + gradientId + ")";
			svg.prependChild(gradient);
		}
